...
// public void setup() {
// user =
// User.builder().username("john").email("abc@gmail.com").password("123ABCabc!@#").build();
...
// Map<String, String> token = JwtUtilServiceImpl.generateToken("john",
// "123ABCabc!@#");
// assertNotNull(token);
// }
...
// Map<String, String> username = JwtUtilServiceImpl.validateToken("Bearer " +
// tokenValue);
